...
// @require           https://asifadeaway.com/utils/ShadowDOMHelper.js?#sha256=e2c555a7dfeef9362ba134e6fef421a129ff562650de6331e6238fa3ba950bec
  ...
  const modules = {
    ...
    async clickVideoTimeAutoLocation() {
      ...
      const stop = ShadowDOMHelper.watchQuery(
        ...
        '#feed',
        async item => {
          const seekLinks = await ShadowDOMHelper.queryUntil(
            item,
          ...
          const replySeekLinks = await ShadowDOMHelper.queryUntil(
            item,
            'bili-comment-replies-renderer >> bili-comment-reply-renderer >> bili-rich-text >> #contents > a[data-type="seek"]',
            {
              findAll: true,
            }
          )
